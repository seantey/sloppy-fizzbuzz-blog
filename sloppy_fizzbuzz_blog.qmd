...
*(This math is for fun, skip to code below for easier read of the logic.)*
...
For actual implementation, refer to section 6 of the [Jupyter notebook](https://github.com/seantey/sloppy-fizzbuzz/blob/main/ugly_fizzbuzz_grpo.ipynb) or read below for a slightly more detailed breakdown of the core components.
